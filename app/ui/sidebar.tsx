...
const Sidebar = React.forwardRef<HTMLDivElement, SidebarProps>(({ isOpen = true, className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
...
const SidebarFooter = React.forwardRef<HTMLDivElement, SidebarFooterProps>(({ className, ...props }, ref) => {
  return <div ref={ref} className={cn("p-4 border-t border-border", className)} {...props} />
})
